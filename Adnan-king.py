...
psb('\x1b[1;32mBANGLADESH Adnan-king 11 DIGIT CLONING START PLEASE WAIT ..........')
...
logo = '\n|._ _ ___ /\ | | | |/ (_) / \ __| |_ __ __ _ _ __ | ' / _ _ __ __ _ / /\ \ / _` | '_ \ / _` | '_ \ | < | | '_ \ / _` | / ____ \ (_| | | | | (_| | | | | | . \| | | | | (_| | /_/ \_\__,_|_| |_|\__,_|_| |_| |_|\_\_|_| |_|\__, | __/ | |___/ 
...
print 'AUTHOR : ADNAN-KING

print 'FACEBOOK : TERMUX MASTER ADNAN'

print 'GITHUB : github.com/TERMUXADNANKING'
...
print '\x1b[1;92m[adnan-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
...
print '\x1b[1;93m[Adnan-king-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
